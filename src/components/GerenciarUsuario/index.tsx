...
const GerenciarUsuario = () => {
  ...
  return (
    <div className="component-accordion" id="gerenciar-usuario">
      <Accordion
        classes={{
          root: "bg-card-green content-container",
        }}
      >
        <AccordionSummary
          ...
          <div className="accordion-header">
            <div className="filtro-container">
              <div className="filtro-input-div form-floating">
                ...
                <input
                  type="text"
                  className="form-control filtro-input bg-card-deep-green"
                  id="usuario-filtro"
            ...
            <div>
              <button
                ...
                type="button"
                className="button submit-button auto-width bg-card-deep-green pd-2"
              >
